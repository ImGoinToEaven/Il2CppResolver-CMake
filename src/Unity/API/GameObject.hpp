...
namespace Unity
{
	...
	public:
		...
		template <typename T>
		T* GetComponent(const char* m_pName)
		{
			return reinterpret_cast<T*(UNITY_CALLING_CONVENTION)(void*, System_String*)>(GameObjectFunctions.m_pGetComponent)(this, IL2CPP::String::New(m_pName));
		}
	...
	namespace GameObject
	{
		...
		template<class T>
		T* Find(const char* m_pName)
		{
			return reinterpret_cast<T*(UNITY_CALLING_CONVENTION)(System_String*)>(GameObjectFunctions.m_pFind)(IL2CPP::String::New(m_pName));
		}
